                    ...
                    <div className="md:col-span-3 p-12 bg-white">
                                ...
                                {currentStep === 1 && (
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <Input label="Position Title" name="position_title" value={formData.position_title} onChange={handleChange} />
                                        </div>
                                        <Select
                        ...
                        <div className="mt-12 flex justify-between">
                            ...
                            {currentStep < steps.length - 1 ? (
                                ...
                                <button
                                    className="bg-brand-gold text-white text-[10px] font-bold uppercase tracking-widest px-10 py-4 rounded-full hover:bg-brand-brown transition-all flex items-center gap-2 shadow-xl shadow-brand-gold/20"
                                >
