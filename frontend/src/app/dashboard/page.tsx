                        ...
                        >
                            ...
                            <div className="p-10">
                                ...
                                <div className="space-y-4 mb-10">
                                    <BenefitItem icon={<Calendar className="w-4 h-4" />} text="Priority Booking & Reservation Protection" />
                                    <BenefitItem icon={<UtensilsCrossed className="w-4 h-4" />} text="Unlimited 'No-Pay' Checkout (Monthly Inclusive)" />
                                    <BenefitItem icon={<Plus className="w-4 h-4" />} text="Access to Elite-only Dinner Events & Tastings" />
                                </div>
                                ...
                                <div className="bg-brand-ivory/50 rounded-2xl p-6 mb-8 border border-brand-brown/5">
                                    <div className="flex justify-between items-center text-brand-brown">
                                        <span className="text-[10px] font-bold uppercase tracking-widest">Subscription Fee</span>
                                        <span className="font-serif text-2xl font-bold">$2,400<span className="text-xs">/mo</span></span>
                                    </div>
                                </div>
            ...
            <main className="py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-12">
                            ...
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                <div className="flex items-start justify-between mb-8">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="font-serif text-xl font-bold tracking-widest uppercase">{userData?.member_id || 'CUL-XXXXXX'}</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-xl shadow-brand-brown/5 border border-brand-brown/5 flex flex-col items-center justify-between group">
                            ...
                            <div className="w-32 h-32 bg-brand-ivory rounded-2xl p-4 border border-brand-brown/5 group-hover:border-brand-gold transition-colors relative overflow-hidden">
                                {userData?.qr_code ? (
                                    <Image
                                        src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${userData.qr_code}`}
                                        alt="Member QR"
                                        width={100}
                                        height={100}
                        ...
                        <div className={`rounded-3xl p-8 flex flex-col justify-between text-white shadow-xl transition-all duration-700 ${isElite ? 'bg-black shadow-black/20' : 'bg-brand-burgundy shadow-brand-burgundy/20'}`}>
                            <div>
                                ...
                                {isElite ? (
                                    <div className="flex items-baseline gap-2">
                                        ...
                                        <span className="text-white/40 font-bold">/ 12</span>
                                    </div>
                                ) : (
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        ...
                        <ActionCard icon={<UserIcon className="w-6 h-6" />} label="Network Expansion" href="/referrals" />
