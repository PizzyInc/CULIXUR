...
export default function Home() {
  return (
    <div className="font-sans antialiased bg-brand-ivory">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 transition-all duration-300 bg-brand-ivory/85 backdrop-blur-md border-b border-brand-brown/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex justify-between items-center h-24">
            <div className="flex items-center">
              <Link href="/" className="flex items-center gap-3">
                <span className="font-serif text-3xl font-bold tracking-tight text-brand-brown">Culixur</span>
              </Link>
            </div>
            ...
            <div className="md:hidden">
              <button className="text-brand-brown">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-32 relative z-10 w-full text-center">
          ...
          >
            <div className="inline-block mb-10">
              ...
              >
                <div className="w-24 h-[1px] bg-brand-gold mb-6 opacity-50"></div>
                <span className="font-serif text-4xl md:text-5xl tracking-[0.5em] uppercase text-brand-gold font-light">
                  Culixur
                </span>
                <div className="w-24 h-[1px] bg-brand-gold mt-6 opacity-50"></div>
              </motion.div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid md:grid-cols-4 gap-16 items-center">
            <div className="col-span-2">
              <h3 className="font-serif text-4xl font-bold mb-6">Culixur</h3>
          ...
          <div className="mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[10px] font-bold uppercase tracking-widest text-white/20">
            <p>&copy; 2025 Culixur. All rights reserved.</p>
            <p className="mt-4 md:mt-0">Crafted by Pizzy Inc.</p>
          </div>
        </div>
      </footer>
    </div>
